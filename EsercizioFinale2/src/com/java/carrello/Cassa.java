...
import com.java.persone.Dipendente;
...
public class Cassa {
	...
	private String[] passwordCassa = {"adminPass", "user1pass", "user2pass"}; 
	...
	public Cassa(String nomeNegozio, String indirizzoNegozio, String cittaNegozio,
			int numeroCassa, String[] usernameCassa, String[] passwordCassa) {
	...
	public boolean accendiCassa(Persona p) {
		...
		for(int i = 0; i < usernameCassa.length; ++i) {
			if(credenziali[0].equals(usernameCassa[i]) &&
					credenziali[1].equals(passwordCassa[i])) {
				cassaAccesa = true;
				return true;
			}
	...
	public Scontrino emettiScontrino(Carrello carrello) {
		if(!cassaAccesa)
			return null; // NON ESISTE LO SCONTRINO
		...
		s.aggiungiRiga(nomeNegozio + "/n");
		s.aggiungiRiga(indirizzoNegozio + "/n");
		s.aggiungiRiga(cittaNegozio + "/n");
		s.aggiungiRiga("...................." + "/n");
	...
	private String generaRiga(ProdottoPrezzato p) {
		return p.getIdProdotto() + "...................." + p.getPrezzo() + "€ /n";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
		...
		result = prime * result + Arrays.hashCode(passwordCassa);
	...
	public boolean equals(Object obj) {
		...
		if (numeroCassa != other.numeroCassa)
			return false;
		if (!Arrays.equals(passwordCassa, other.passwordCassa))
			return false;
	...
	public String toString() {
		return "Cassa [nomeNegozio=" + nomeNegozio + ", indirizzoNegozio=" + indirizzoNegozio + ", cittaNegozio="
				+ cittaNegozio + ", usernameCassa=" + Arrays.toString(usernameCassa) + ", passwordCassa="
				+ Arrays.toString(passwordCassa) + ", numeroCassa=" + numeroCassa + ", cassaAccesa=" + cassaAccesa
				+ "]";
	}
